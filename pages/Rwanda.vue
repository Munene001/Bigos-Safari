    ...
    <div v-else-if="country">
      ...
      <div class="w-full h-[500px] md:h-[500px] relative overflow-hidden">
        ...
        >
          ...
          >
          Home to misty mountains and rare mountain gorillas, Rwanda is a country of serene beauty and resilience, where lush landscapes and vibrant culture offer deeply moving experiences.
          </div>
        ...
        <div class="md:w-[60%] flex flex-col gap-[20px]">
          ...
          >
            <div class="flex flex-col gap-[10px]">
              <div class="text-[28px] md:text-[32px] font-bold leading-[28px]">RWANDA OVERVIEW</div>
              <div class="hidden md:block font-medium">Rwanda is known as the “Land of a Thousand Hills” and is one of the cleanest countries in the world—plastic bags have been banned since 2008.</div>
            </div>
            <img src="/rw.jpeg" class="height-[50px]" />
          </div>
  ...
  const fetchCountry = async () => {
    ...
    try {
      const response = await axios.get<Country>(
        `http://127.0.0.1:8000/api/countries/5`,
        {
          headers: {
